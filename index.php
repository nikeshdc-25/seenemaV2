...
<body id="top">
    ...
    <!-- Carousel -->
    <div id="featureCarousel" class="carousel slide mx-5 my-2" data-ride="carousel">
        <span style="color: #8b8b8b; font-weight: 700;"><i class="fa-solid fa-thumbs-up" style="font-size:20px; color:darkorange;"></i> Recommended Movies:</span>
