...
<div class="container">
        ...
        <div class="row align-items-end">
            ...
            <div class="col-md-4">
                <div class="movie-info">
                    <h2 style="color: #f5f5f5;"><b><?php echo htmlspecialchars($movie['title']); ?></b></h2>
                    ...
                    <p><strong>Release:</strong> <em> <?php echo date('F j, Y', strtotime($movie['release_date'])); ?></em></p>
    ...
    document.getElementById('userComment').addEventListener('keydown', function(event) {
    if (event.keyCode === 13) {
